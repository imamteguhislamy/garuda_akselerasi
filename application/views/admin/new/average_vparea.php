...
<head>
    ...
    <title>Admin | Average VP Area</title>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <div class="m-t-sm">
                                    <div>
                                        <h3 class="font-bold no-margins">VP Area Domestik</h3>
                                        <br>
                                    </div>
                                    <div class="row">
                                        <!-- MESAM -->
                                        <div class="col-xs-6 col-md-3 text-center">
                                            <div class="knob-label">
                                                <h3><?php echo $progresvparea[5]->kode_unit; ?></h3>
                                            </div>
                                        ...
                                        <div class="col-xs-6 col-md-3 text-center">
                                            <div class="knob-label">
                                                <h3><?php echo $progresvparea[2]->kode_unit; ?></h3>
                                            </div>
                                            <input type="text" class="knob"                                             
                                        ...
                                        <div class="col-xs-6 col-md-3 text-center">
                                            <div class="knob-label">
                                                <h3><?php echo $progresvparea[8]->kode_unit; ?></h3>
                                            </div>
                                            <input type="text" class="knob"                                             
                                        ...
                                        <div class="col-xs-6 col-md-3 text-center">
                                            <div class="knob-label">
                                                <h3><?php echo $progresvparea[12]->kode_unit; ?></h3>
                                            </div>
                                            <input type="text" class="knob"                                             
                                                value=<?php echo number_format($progresvparea[12]->progress,0,".","."); ?>
                                                data-min="0" 
                                                data-max=<?php echo 100;?> 
                                                data-width="180" 
                                                data-height="200" 
                                    ...
                                    <div>
                                        <br>
                                        <h3 class="font-bold no-margins">VP Area Internasonal</h3>
                                        <br>
                                    </div>
                                    <div class="row">
                                        <!-- AMSDM -->
                                        <div class="col-xs-6 col-md-3 text-center">
                                            <div class="knob-label">
                                                <h3><?php echo $progresvparea[0]->kode_unit; ?></h3>
                                            </div>
                                            <input type="text" class="knob"                                             
                                        ...
                                        <div class="col-xs-6 col-md-3 text-center">
                                            <div class="knob-label">
                                                <h3><?php echo $progresvparea[1]->kode_unit; ?></h3>
                                            </div>
                                            <input type="text" class="knob"                                             
                                        ...
                                        <div class="col-xs-6 col-md-3 text-center">
                                            <div class="knob-label">
                                                <h3><?php echo $progresvparea[3]->kode_unit; ?></h3>
                                            </div>
                                            <input type="text" class="knob"                                             
                                        ...
                                        <div class="col-xs-6 col-md-3 text-center">
                                            <div class="knob-label">
                                                <h3><?php echo $progresvparea[4]->kode_unit; ?></h3>
                                            </div>
                                            <input type="text" class="knob"                                             
                                        ...
                                        <div class="col-xs-6 col-md-3 text-center">
                                            <div class="knob-label">
                                                <h3><?php echo $progresvparea[6]->kode_unit; ?></h3>
                                            </div>
                                            <input type="text" class="knob"                                             
                                        ...
                                        <div class="col-xs-6 col-md-3 text-center">
                                            <div class="knob-label">
                                                <h3><?php echo $progresvparea[7]->kode_unit; ?></h3>
                                            </div>
                                            <input type="text" class="knob"                                             
                                        ...
                                        <div class="col-xs-6 col-md-3 text-center">
                                            <div class="knob-label">
                                                <h3><?php echo $progresvparea[9]->kode_unit; ?></h3>
                                            </div>
                                            <input type="text" class="knob"                                             
                                        ...
                                        <div class="col-xs-6 col-md-3 text-center">
                                            <div class="knob-label">
                                                <h3><?php echo $progresvparea[10]->kode_unit; ?></h3>
                                            </div>
                                            <input type="text" class="knob"                                             
