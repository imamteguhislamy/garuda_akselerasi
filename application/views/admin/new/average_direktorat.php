...
<head>
    ...
    <title>Admin | Average Direktorat</title>
                                    ...
                                    <div class="row">                                
                                        <div class="col-xs-6 col-md-4 text-center">
                                            <div class="knob-label">
                                                <h3><?php echo $progres[0]->kode_dir; ?></h3>
                                            </div>
                                        ...
                                        <div class="col-xs-6 col-md-4 text-center">
                                            <div class="knob-label">
                                                <h3><?php echo $progres[1]->kode_dir; ?></h3>
                                            </div>
                                            <input type="text" class="knob"                                             
                                        ...
                                        <div class="col-xs-6 col-md-4 text-center">
                                            <div class="knob-label">
                                                <h3><?php echo $progres[2]->kode_dir; ?></h3>
                                            </div>
                                            <input type="text" class="knob"                                             
                                        ...
                                        <div class="col-xs-6 col-md-4 text-center">
                                            <div class="knob-label">
                                                <h3><?php echo $progres[3]->kode_dir; ?></h3>
                                            </div>
                                            <input type="text" class="knob"                                             
                                        ...
                                        <div class="col-xs-6 col-md-4 text-center">
                                            <div class="knob-label">
                                                <h3><?php echo $progres[4]->kode_dir; ?></h3>
                                            </div>
                                            <input type="text" class="knob"                                             
                                        ...
                                        <div class="col-xs-6 col-md-4 text-center">
                                            <div class="knob-label">
                                                <h3><?php echo $progres[5]->kode_dir; ?></h3>
                                            </div>
                                            <input type="text" class="knob"                                             
                                        ...
                                        <div class="col-xs-6 col-md-4 text-center">
                                            <div class="knob-label">
                                                <h3><?php echo $progres[6]->kode_dir; ?></h3>
                                            </div>
                                            <input type="text" class="knob"                                             
                                        ...
                                        <div class="col-xs-6 col-md-4 text-center">
                                            <div class="knob-label">
                                                <h3><?php echo $progres[7]->kode_dir; ?></h3>
                                            </div>
                                            <input type="text" class="knob"                                             
                                        ...
                                        <div class="col-xs-6 col-md-4 text-center">
                                            <div class="knob-label">
                                                <h3><?php echo $progres[8]->kode_dir; ?></h3>
                                            </div>
                                            <input type="text" class="knob"                                             
